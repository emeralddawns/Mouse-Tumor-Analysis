...
The **Pymaceuticals** code currently calculates and displays the following:
    ...
    A box and whisker plot of the final tumor volume for all four treatment regimens with potential outliers highlighted
...
1) Capomulin and Ramicane appear to outperform Infubinol and Ceftamin in regards to reducing tumor volume (mm3).
